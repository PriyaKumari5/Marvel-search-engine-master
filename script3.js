...
function connection() {
    const xhr = new XMLHttpRequest();
    const name = document.getElementById("name").value;
    const params = "name=" + name;   //name=hulk
  ...
  // INCASE OF LOAD END
      ...
      xhr.open("GET", `http://gateway.marvel.com/v1/public/characters?${params}&ts=1&apikey=50635b3dbeecd170749fec4be564feee&hash=528bf10b89554b503d3b91ade4ff86f8
      `, true);
...
function comics(characterID) {
  ...
  // ON ERROR
    ...
    xhr.open("GET", `http://gateway.marvel.com/v1/public/characters?${id}comics?&ts=1&apikey=50635b3dbeecd170749fec4be564feee&hash=528bf10b89554b503d3b91ade4ff86f8
    `, true);
